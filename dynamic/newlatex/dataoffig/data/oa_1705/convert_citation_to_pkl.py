...
输入: data/citation_lifescience/oa_1705_coo/*.xlsx
输出: data/citation_lifescience/oa_1705_coo_pkl/*.pkl
...
def main():
    ...
    excel_dir = os.path.join(script_dir, 'oa_1705_coo')
    output_dir = os.path.join(script_dir, 'oa_1705_coo_pkl')
